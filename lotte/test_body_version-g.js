					...
					<div class="wow fadeIn bbackg"> 
							 ...
							 <div class="img-text md-top3 lg-top3 top-space " style="font-size:14px;">
							  ...
							  <div style="position:relative;">
								...
								<span style="font-size:20px;">절대 손해보지 않는<br>오늘 하루만! 특가 이벤트</span>
...
<br><br>
								...
								<center><h1><span class="questm ft-white">견적 유형</span></h1></center><br>
								<center><input class="choice click_belly" id="hope_1" name="entry.272078534" type="radio" value="장기렌트" /> <label class="label_button1" for="hope_1" onclick="car1();jump_quest(0);focus();" >장기렌트</label></center>

								<center><input class="choice click_side" id="hope_2" name="entry.272078534" type="radio" value="신차리스" /> <label class="label_button1" for="hope_2" onclick="car2();jump_quest(0);focus()">신차리스</label></center>
	 ...
	 <br> 
                                ...
                                <center><br><div class=" alert_msg">
                                 ...
                                 <span class="tip-text ">원하시는 차종의<br>이벤트 매물을 찾습니다.</span><br><br>	
                                 </div>
	...
	<br><br><br>
				  ...
				  <!--메인 화면 SECTION-->
						  ...
						  <section  id="quest0_wrap" class="wow fadeIn backg container1" >
							  ...
							  <img src="./lotte/mirror.jpg" class="bg-img br20" style="min-height:900px;max-height:950px">
		
							  <div class="wow fadeIn quest-text ft-white" style="top:15% !important">	

								
							  <span style="font-size:20px;">견적가를 확 낮출 수 있는<br>오늘의 이벤트 매물 찾아보기</span>
							  <img src="./lotte/fire.png" style="width:20px;margin-top:-8px;"><br><br>
							
							  <h1 style="position:relative;z-index:100;font-size:33px;font-weight:bold;" id="countdown"></h1>
							  
							  <h3  class="textleft wow fadeInUp">적은 수량에 금방 마감되는 만큼<br><u class="underline">"현재 페이지에서만 제공됩니다."</u></h3>

							  <p style="font-size:25px;font-weight:bold"class="blink">신청자 순으로 선착순 마감됩니다!</p>

<br>
						  <!--질문 문구 부분 시작-->
							  <center><h1><span class="questm ft-white">원하는 차종</span></h1></center>
						 
						  <!--질문을 띄어쓰기 하려면 '<br>'을 적으시면 됩니다-->
						  <input name="entry.34131472" class="test_input bb-white"  type="text"  id="car-model" style="width:100%;text-align:center;" maxlength="30" oninput="maxLengthCheck(this)" onkeyup="car_model()"><label class="ft-white" ></label><br><br>
						  <!--질문 문구 부분 끝-->
					   ...
					   <!-- end chat -->
						  ...
						  <center><input name="entry.quest0" id="quest0_1" class="input_font quest0 click_goal_weight" type="radio" value="다음" style="text-align:center;" disabled="disabled">
							  <label class="label_button1 disabled" id="next_gw" for="quest0_1" style="text-align:Center;" onclick="go_name()">다음</label></center>	
							  </div>
			...
			<span>사업장 소재지 : 서울특별시 도봉구 도봉로 921, 3층(도봉동, 삼화빌딩)</span>
						 ...
						 <!--나는 어떤 부모인가요?-->
									 ...
									 <section  id="quest7_wrap" class="wow fadeIn backg container1" >
									  <img src="./lotte/mirror.jpg" class="bg-img br20" style="min-height:900px;max-height:1000px">
		
									  <div class="wow fadeIn quest-text ft-white" style="top:15% !important">
									
                                      <span style="font-size:20px;"><br>절대 손해보지 않는<br>오늘 하루만! 특가 이벤트</span>
                                      <img src="./lotte/fire.png" style="width:20px;margin-top:-8px;">
                                    
                                      <!-- <h1 style="position:relative;z-index:100;font-size:33px;font-weight:bold;" id="countdown"></h1> -->
                                      
                                      <h3  class="textleft wow fadeInUp">원하시는 옵션 특가를<br><u class="underline">"현재 페이지에서만 제공합니다."</u></h3>
      
                                      <p style="font-size:30px;font-weight:bold"class="blink"> 선착순 50명!</p>
      <br>
      

								  <center><h1><span class="questm ft-white">희망 차종</span></h1></center>
								  <center><input class="choice click_belly" id="hope_1" name="entry.272078534" type="radio" value="장기렌트" /> <label class="label_button1" for="hope_1" onclick="car1();jump_quest(0);focus();" >장기렌트</label></center>
