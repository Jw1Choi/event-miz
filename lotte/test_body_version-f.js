...
<br><br>
								...
								<center><input class="choice click_belly" id="hope_1" name="entry.272078534" type="radio" value="장기렌트" /> <label class="label_button1" for="hope_1" onclick="car1();jump_quest(5);focus();" >장기렌트</label></center>

								<center><input class="choice click_side" id="hope_2" name="entry.272078534" type="radio" value="신차리스" /> <label class="label_button1" for="hope_2" onclick="car2();jump_quest(5);focus()">신차리스</label></center>
	...
	<br><br><br>
				  ...
				  <!--메인 화면 SECTION-->
						  ...
						  <!--질문0번 SECTION-->	
						  <section  id="quest0_wrap" class="wow fadeIn backg" >
...
<br>
					   ...
					   <!-- end chat -->
						  ...
						  <center><input name="entry.quest0" id="quest0_1" class="input_font quest0 click_goal_weight" type="radio" value="다음" style="text-align:center;" disabled="disabled">
							  <label class="label_button1 disabled" id="next_gw" for="quest0_1" style="text-align:Center;" onclick="go_car()">다음</label></center>	
							  </div>
